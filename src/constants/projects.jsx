  ...
  },
  {
    ...
    copy: {
      ...
      thoughtProcess: `
          ...
          also had trouble displaying data with EJS and working with Node.js and Express.js. My solution was to read any documentation there was and, if I couldn't find an answer, look it up on
